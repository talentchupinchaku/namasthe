                ...
                for target_word in Saametha.target_word_list:
                    if target_word in bondha_comment.body.lower() and bondha_comment.author.name != "nee_charithra_bot":
                        if (len(my_comment_set & bondha_comment_set)) == 0:
                            ...
                            bondha_comment.reply(body="You said saametha somewhere in your comment and I'm supposed to respond with a one, but I disabled this work temporarily. I will make some changes and reenable this in few weeks")
