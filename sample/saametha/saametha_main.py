...
class Saametha:
    ...
    responses = [
        ...
        "ఇంటికి గుట్టు రోగానికి రట్టు ఉండాలంటారు",
        "ఏం లేనోనికి ఏతులెక్కువ చెల్లని రూపాయికి గీతలెక్కువ",
        "కోల ఆడితేనే కోతి ఆడుతుంది",
        "సూది కోసం సోదికెళ్తే పాత రంకు అంతా బైట పడిందట",
        "చెట్టు వెనుకాల చందమామ తొంగి తొంగి చూస్తుందని గుడిసె వెనకాల కోడి గుడ్డు పెట్టనందట",
        "నీరు పల్లమెరుగు నిజం దేవుడెరుగు",
        "వినాశ కాలే విపరీత బుద్ధి",
        "కామి కానివాడు మోక్షగామి కాలేడు",
        "తాటిచెట్టు  కింద పాలు తాగిన కల్లే అంటారు",
        "ముందర వాళ్ళకి మూకుళ్ళు వెనకాల వాళ్లకి నాకుళ్ళు",
        "తాను దూర సందు లేదు మెడకొక డోలు అన్నట్లు",
        "వడ్డించే వాడు మనవాడు అయితే ఎక్కడ కూర్చున్న ఫర్వాలేదు",
        "పనిగలవాడు పందిరిస్తే కుక్క తోక తగిలి కూలిందట",
        "అల్పుడు కి ఐశ్వర్యం వస్తే అర్ధరాత్రి వేళ గొడుగు పట్టమన్నాడట",
        "ఇల్లు కాలి ఒకడు ఏడుస్తుంటే చుట్టకి నిప్పు కావాలన్నాడుట ఇంకొకడు",
        "గొర్రె కసాయి వాడినే నమ్ముతుంది",
        "దున్నపోతు ఈనింది అంటే దూడని కట్టెయ్యమన్నాడట!",
        "కడుపులో లేనిది కౌగలించుకుంటే వస్తుందా?",
        "జమ్మి ఆకులతో విస్తరి కుట్టినట్లు!"
    ]
    target_word_list = ["saametha", "sametha", "sameta", "saameta", "సామెత",
                        "సామిత", "saamitha", "saamita", "samita", "samitha", "sameetha", "!sametha", "!saametha", "!sameta", "!saameta", "!సామెత",
                    ...
                    if target_word.strip().lower() == bondha_comment.body.strip().lower() and bondha_comment.author.name != "nee_charithra_bot":
                        ...
                        if (len(my_comment_set & bondha_comment_set)) == 0:
                            used_indexes_blob_client = Saametha.blob_service_client.get_blob_client(
                                container="proverbs", blob="used_proverb_indexes_old_version")
                            if used_indexes_blob_client.exists():
                                random_index_list = json.loads(used_indexes_blob_client.download_blob().readall())
