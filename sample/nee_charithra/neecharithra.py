                ...
                for target_word in NeeCharithra.target_word_list:
                    if target_word in bondha_comment.body.lower() and bondha_comment.author.name != "nee_charithra_bot":
                        if (len(my_comment_set & bondha_comment_set)) == 0:
                            ...
                            bondha_comment.reply(body="Hello u/" + bondha_comment.author.name + " you asked for charithra somewhere in your comment and I'm supposed to respond with your acitivity, but I disabled this work temporarily. I will make some changes and reenable this in few weeks")
